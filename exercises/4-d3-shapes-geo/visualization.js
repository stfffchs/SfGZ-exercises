document.addEventListener("DOMContentLoaded", () => {
    ...
    // 4. Stadt hinzufügen >> Koordinaten aus Web. Achtung, Koordinaten umgekehrt einfügen
    const zuerich = svg.append("circle")
        .attr("cx", d => projection([8.55, 47.36667])[0])
        .attr("cy", d => projection([8.55, 47.36667])[1])
        .attr("r", 10)
        .attr("fill", "#FFFFFF")
